 ...
 * }
 * */
$createMessageFunction = function() use ($app){
...
$getMessageFunction = function($id) use ($app){
...
$getChatTimelineFunction = function($id) use ($app){
    $timeline = new ChatTimeline($id);
    $timeline->select($id);
    
    throwSuccess($app,$timeline);
};

$app->post('/message/', $createMessageFunction);
$app->get('/message/:id', $getMessageFunction);
//$app->post('/message/:id', $getMeesageFunction($id));
$app->get('/ChatTimeline/:id', $getChatTimelineFunction);
